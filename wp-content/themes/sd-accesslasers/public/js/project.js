  ...
  init: function init() {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $heroSlider).length) {
      ...
      var updateSliderCounter = function updateSliderCounter(slick, currentIndex) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-arrows .counter', $heroSlider).text(currentSlide + '/' + slick.slideCount);
      };

      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $heroSlider).on('init', function (event, slick) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $heroSlider).on('afterChange', function (event, slick, currentSlide) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $heroSlider).slick({
        ...
        speed: 300,
        nextArrow: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-next', $heroSlider),
        prevArrow: jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-prev', $heroSlider)
      });
    }
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $slider).length) {
      ...
      var _updateSliderCounter = function _updateSliderCounter(slick, currentIndex) {
        _currentSlide = slick.slickCurrentSlide() + 1;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-arrows .counter', $slider).text(_currentSlide);
      };

      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $slider).on('init', function (event, slick) {
        _updateSliderCounter(slick);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick', $slider).on('afterChange', function (event, slick, currentSlide) {
        _updateSliderCounter(slick, currentSlide);
      });
...
/* harmony import */ var _modules_background_video__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/background-video */ "./assets/js/modules/background-video.js");
/* harmony import */ var _modules_accordion_fix__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/accordion-fix */ "./assets/js/modules/accordion-fix.js");
/* harmony import */ var _modules_full_screen_scrolling_section__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/full-screen-scrolling-section */ "./assets/js/modules/full-screen-scrolling-section.js");
...
var modules = new _loader_ModuleLoader__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  // facetWp,
  fixedHeader: _modules_fixed_header__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  // superfish
  backgroundVideo: _modules_background_video__WEBPACK_IMPORTED_MODULE_10__["default"],
  //menuToggle,
...
__webpack_require__(/*! /Users/kylerumble/Local Sites/accesslaser/app/public/wp-content/themes/sd-accesslasers/assets/js/project.js */"./assets/js/project.js");
__webpack_require__(/*! /Users/kylerumble/Local Sites/accesslaser/app/public/wp-content/themes/sd-accesslasers/assets/scss/style.scss */"./assets/scss/style.scss");
module.exports = __webpack_require__(/*! /Users/kylerumble/Local Sites/accesslaser/app/public/wp-content/themes/sd-accesslasers/assets/scss/login.scss */"./assets/scss/login.scss");
